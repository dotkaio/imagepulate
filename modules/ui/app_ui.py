...
class AppUI:
    ...
    def create_video_segmentation_tab(self) -> None:
        ...
        with gr.TabItem(_("Video Segmentation")):
            ...
            btn_open_folder.click(
                fn=lambda: open_folder(os.path.join(
                    self.args.output_dir, "filter")),
                inputs=None,
                outputs=None
            )
    ...
    def create_layer_divider_tab(self) -> None:
        ...
        with gr.TabItem(_("Layer Divider")):
            ...
            with gr.Row():
                gallery_output = outputs['gallery_output']  # type: ignore
                with gr.Column():
                    output_file = outputs['file_output']  # type: ignore
                    btn_open_folder = gr.Button(
                        _("📁 Open PSD folder"), scale=1)
            ...
            btn_open_folder.click(
                fn=lambda: open_folder(os.path.join(
                    self.args.output_dir, "psd")),
                inputs=None,
                outputs=None
            )

            dd_input_modes.change(  # type: ignore
    ...
    def create_interface(self) -> gr.Blocks:
        ...
        with demo:
            with self.i18n:
                ...
                md_prompt_guide = gr.Markdown(
                    _("If you don't know how to prompt"))
